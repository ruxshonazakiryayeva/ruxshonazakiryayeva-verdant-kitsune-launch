...
const translations: Record<Lang, Record<string, string>> = {
  uz: {
    ...
    "hero.env.text":
      "Sizni to'yimizga taklif qilamiz · 12-sentabr, 2027 · Samarqand",
    ...
    "price.premium.note": "Shablonlar yoqmadimi? O'zingiz xohlagan uslubda, noldan yasab beramiz.",
    ...
    "foot.made": "Mehr bilan yaratilgan",
  },
  ru: {
    "nav.catalog": "Каталог",
    ...
    "hero.env.text":
      "Приглашаем вас на свадьбу · 12 сентября 2027 · Самарканд",
  ...
  en: {
    ...
    "hero.env.text":
      "You're invited to our wedding · September 12, 2027 · Samarkand",
...
const CATALOG: CatItem[] = [
  ...
  },
  {
    ...
    title: "Imronbek",
    descKey: "cat.item9",
    href: "https://imronbek-birthday-invent.vercel.app/",
